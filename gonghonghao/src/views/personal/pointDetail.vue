          ...
          >
            <div class="my-wallet-item" v-for="dataList in list" :key="dataList.id">
              <van-cell label="2019-10-31">
                <div slot="title" class="my-wallet-item-title">
                  <div>{{dataList.parentUserAccountName ? dataList.parentUserAccountName:dataList.parentUserAccount|deName}}</div>
                  <div>{{dataList.parentUserAccount|phoneFilter}}</div>
                </div>
...
.my-wallet-item-title{
  display: flex;
  flex-direction: column;
}
.my-wallet-item-title>div:nth-of-type(1){
  color: #222;
}
.my-wallet-item-title>div:nth-of-type(2){
  font-size: .88rem;
  color: #222;
}
</style>
